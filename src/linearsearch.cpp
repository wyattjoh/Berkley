...
{	
	...
	// 
	// myDB.put(&index, &data2);
	// 	
	// std::string *gotData = myDB.getP(&index);
	// 	
	// std::cout << *gotData << std::endl;
	// 
	// index--;
	// 
	// gotData = myDB.getP(&index);
	// 	
	// std::cout << *gotData << std::endl;
	// 
	// return 0;
	...
	// 			
		...
		std::string *testData = myDB.getP(&quriedID);
		
		std::cout << *testData << std::endl;
		
		
		// std::string gotData = myDB.get(&index);
	// 		
		// std::cout << "DATA>" << quriedID << "," << gotData << std::endl;
	// 		
	// 		// if(gotData->size() > 0)
	// 		// 		{
